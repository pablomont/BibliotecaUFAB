...
public class DBConfig {
	...
	*/	
	...
	@Bean
	/** Cria��o do SessionFactory alocando DataSource, PackagesToScan e HibernateProperties
	...
	/** Cria��o do DataSource alocando DriverClassName, Url, Username e Password da database 
	 *  @return dataSource   
	 */
	@Bean
	...
	/** Cria��o do HibernateTransactionManager usando sessionFactory 
	...
	/** Cria��o das propriedades do hibernate
	 *  @return properties   
	 */
